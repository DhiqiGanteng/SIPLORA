...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/rekapitulasiDaerah.css">
        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
               ...
               <a href="{{url('/berandaBDPB/rekapitulasiBDPB')}}" class="list-group-item list-group-item-action active btnActive"> <i class="fas fa-clipboard-check"></i> Rekapitulasi</a>
             </div>
          </div>
