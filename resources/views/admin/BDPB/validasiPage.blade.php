...
<head>
  ...
  <title>Validasi Laporan BDPB</title>
    ...
    <nav id="sidebar">
      ...
      <div class="col-md-12 list-rute">
        <div class="list-group">
           ...
           <a href="{{url('/berandaBDPB/instruksiBDPB')}}" class="list-group-item list-group-item-action"> <i class="fas fa-cog"></i> Instruksi Laporan</a>
           <a href="{{url('/berandaBDPB/validasiBDPB')}}" class="list-group-item list-group-item-action active btnActive"> <i class="fas fa-check-square"></i> Validasi Laporan</a>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid">
            <div class="row">
              ...
              <h4>Validasi Admin BDPB {{Session::get('daerah')}}</h4>
            </div>
                    ...
                    @foreach($data as $laporan)
                     <tr>
                       ...
                       <td><div class="row">
                         ...
                         <form method="post" action="/berandaBDPB/validasiBDPB/diterima/{{ $laporan->id }}" >
                           {{ csrf_field() }}
                               {{ method_field('PATCH') }}
                            <button type="submit" class="btn btn-outline-success validasiBTN"><i class="fas fa-check-double"></i></button>
                            </form>
                            <form method="POST" action="/berandaBDPB/validasiBDPB/ditolak/{{ $laporan->id }}" >
                             {{ csrf_field() }}
                                 {{ method_field('PATCH') }}
