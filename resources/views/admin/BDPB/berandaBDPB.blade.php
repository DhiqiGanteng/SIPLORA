        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
               <a href="{{url('/berandaBDPB')}}" class="list-group-item list-group-item-action active btnActive">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <h4>Dashboard Admin BDPB {{Session::get('daerah')}}</h4>
                </div>
