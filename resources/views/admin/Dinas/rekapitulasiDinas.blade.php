...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/rekapitulasiDinas.css">
        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
              ...
              <a href="{{url('/konfirmasiDinas')}}" class="list-group-item list-group-item-action ">
              <i class="fas fa-clipboard-check"></i>  Konfirmasi Tindak Lanjut
              </a>
               <a href="{{url('/berandaBNPB/rekapitulasiDinas')}}" class="list-group-item list-group-item-action active btnActive"> <i class="fas fa-clipboard-check"></i> Rekapitulasi</a>
             </div>
          </div>
