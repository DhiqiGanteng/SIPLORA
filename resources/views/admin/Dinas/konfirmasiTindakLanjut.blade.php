        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
               <a href="{{url('/berandaDinas')}}" class="list-group-item list-group-item-action ">
               <i class="fas fa-tachometer-alt"></i>  Dashboard
               </a>
               <a href="{{url('/konfirmasiDinas')}}" class="list-group-item list-group-item-action active btnActive">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <h4>Konfirmasi Admin Dinas {{Session::get('daerah')}}</h4>
                </div>
              ...
              <div class="konfirmasi">
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                        <h1>Konfirmasi Tindak Lanjut Laporan</h1>
                           ...
                           <tbody>
                             ...
                             <tr>
                               ...
                               <td><div class="row">
                                 ...
                                 <form method="post" action="/konfirmasiDinas/Terlaksana/{{ $laporan->id }}" >
                                   {{ csrf_field() }}
                                       {{ method_field('PATCH') }}
                                    <button type="submit" class="btn btn-outline-success konfirmasiBTN"><i class="fas fa-check"></i></button>
                                    </form>
                               </td>
                             </tr>
                             @endforeach
