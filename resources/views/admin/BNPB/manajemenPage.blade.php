        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
               ...
               <a href="{{url('/berandaBNPB/manajement')}}" class="list-group-item list-group-item-action active btnActive"> <i class="fas fa-cog"></i> Manajemen Laporan</a>
                                ...
                                <td>
                                    <div class="row">
                                      <!-- Button trigger modal -->
                                        ...
                                        <form method="POST" action="/berandaBNPB/manajement/diterima/{{ $laporan->id }}" >
                                            {{ csrf_field() }}
                                              {{ method_field('PATCH') }}
                                        <button type="submit" class="btn btn-outline-success manajemenBTN"><i class="fas fa-angle-double-right"></i></button>
                                            </form>
                                        <form method="POST" action="/berandaBNPB/manajement/ditolak/{{ $laporan->id }}">
                                              {{ csrf_field() }}
                                              {{ method_field('PATCH') }}
