...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/berandaBNPB.css">
        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
               <a href="{{url('/berandaBNPB')}}" class="list-group-item list-group-item-action active btnActive">
        ...
        <div id="content">
          ...
          <div class="row">
             <div class="form-group col-sm-6">
                    <form method="post" action="/berandaBNPB">
                      {!! csrf_field() !!}
                    ...
                    <button type="submit" class="btn btn-outline-danger">Lihat Rekapitulasi</button>
                    </div>
                </form>
          </div>
          <div class="row">
