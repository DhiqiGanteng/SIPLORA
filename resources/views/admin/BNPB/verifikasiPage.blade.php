        ...
        <nav id="sidebar">
          ...
          <div class="col-md-12 list-rute">
            <div class="list-group">
               ...
               <a href="{{url('/berandaBNPB/verifikasi')}}" class="list-group-item list-group-item-action active btnActive"> <i class="fas fa-clipboard-check"></i> Verifikasi Laporan</a>
               <a href="{{url('/berandaBNPB/rekapitulasiBNPB')}}" class="list-group-item list-group-item-action"> <i class="fas fa-clipboard-check"></i> Rekapitulasi</a>
             </div>
          </div>
                        ...
                        <table class="table" id="haha">
                           ...
                           <tbody>
                              ...
                              <tr>
                                ...
                                <form method="POST" action="/berandaBNPB/verifikasi/diterima/{{ $laporan->id }}" >
                                  {{ csrf_field() }}
                                    {{ method_field('PATCH') }}
                                    <button type="submit" class="btn btn-outline-success verif2"><i class="fas fa-check-square verifikasi"></i></button>
                                  </form>
                                  <form method="POST" action="/berandaBNPB/verifikasi/ditolak/{{ $laporan->id }}" >
                                    {{ csrf_field() }}
                                    {{ method_field('PATCH') }}
